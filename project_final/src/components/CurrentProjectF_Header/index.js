  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header2}>
        <View style={styles.header2Border}>
          ...
          <View style={styles.jobApply}>
            ...
            <Text style={styles.txtJob}>Current Project</Text>
          </View>
        </View>
      ...
      <View style={styles.header3}>
        <Text style={styles.projectTxt}>Current Projects</Text>
        <Text style={styles.profileTxt}>Complete Projects</Text>
      </View>
...
export default CurrentProjectF_Header;
