...
const ProjectF_Content = ({title, subTitle, txtBtn, icons, backgroundColor, width}) => {
  return (
          <View style={styles.container(backgroundColor)}>
                {/* <View style={{}}> */}
                <View style={{flexDirection: 'row', height: 21}}>
                  <ProjectF_Label labelFamily= 'Segoe UI Bold' labelSize= {16} title={title} />
                  <Gap width={width} />
                    <View >
                      <Text>{icons}</Text>
                    </View>
